...
interface Props {
    achievement?: ScopeOfWOrk;
    onNeedRefresh : () => void
}

function AddEditScopeOfWork({ achievement, onNeedRefresh}: Props) {
    ...
    const onSubmit = async (values: z.infer<typeof ScopeOfWorkValidation>) => {
        try {
            setSaveLoading(true)
...
export default AddEditScopeOfWork;