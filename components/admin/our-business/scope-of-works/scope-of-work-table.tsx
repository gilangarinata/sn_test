...
function ScopeOfWorkTable() {
    ...
    const [achievements, setAchievements] = useState<ScopeOfWOrk[]>()
    async function getAchievements() {
        const achievements = await fetchScopeWork()
    ...
    const [open, setOpen] = useState<{banner : ScopeOfWOrk | null, isOpen : boolean}>({banner: null, isOpen:false});
    const [deleteLoading, setDeleteLoading] = useState(false);
    const [createBannerOpen, setCreateBannerOpen] = useState<{banner : ScopeOfWOrk | null, isOpen : boolean}>({banner: null, isOpen: false})
