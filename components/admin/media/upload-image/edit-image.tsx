...
import {ImageDataNew} from "@/components/admin/media/upload-image/upload-image-table";
import {createImage} from "@/lib/actions/admin/upload-image.action";
...
function AddEditImage({ achievement, onNeedRefresh, type}: Props) {
