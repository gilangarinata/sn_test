                ...
                (
                    <DropdownMenu key={route.label}>
                        ...
                        <DropdownMenuContent className="hover:cursor-pointer z-[100]">
                            <DropdownMenuItem><CustomLink lang={lang} className="w-full" href="/media/news"><a className="w-full" onClick={clickCallback}>News</a></CustomLink></DropdownMenuItem>
                            <DropdownMenuItem><CustomLink lang={lang} className="w-full" href="/media/video"><a className="w-full" onClick={clickCallback}>Video</a></CustomLink></DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
