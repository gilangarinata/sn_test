...
export default function ProjectMap({ projects }: { projects: any[] }) {
    ...
    return (
        <div className="w-full flex justify-center py-10 px-4">
            {/* Map Container */}
            <div className="relative w-full max-w-5xl aspect-[16/9] md:aspect-[21/9] lg:aspect-[2.35/1]">
                ...
                {projects.map((project, idx) => (
                    ...
                    >
                        {/* Connecting Line (Only visible on hover or large screens depending on logic, let's show on hover) */}
                        <div className="absolute left-1/2 bottom-full w-px h-10 bg-[#355b81] transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none origin-bottom scale-y-0 group-hover:scale-y-100" />
                        
                        {/* Tooltip Card */}
                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 -translate-y-12 opacity-0 group-hover:opacity-100 scale-95 group-hover:scale-100 transition-all duration-300 pointer-events-none origin-bottom w-max max-w-[320px] md:max-w-[400px]">
                        ...
                        <div className="relative transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 md:w-6 md:h-6 cursor-pointer drop-shadow-md hover:scale-125 transition-transform duration-200">
