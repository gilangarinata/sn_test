    ...
    return (
            <section className="w-full pt-8">
                <div className="bg-[#15537A] z-50 relative rounded-3xl max-w-5xl mx-auto flex flex-col justify-center items-center p-6 gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col text-[#FABD24]">
                            ...
                            <p>
                                SESNA Group (PT Sumber Energi Surya Nusantara) is an Indonesian renewable energy company focused on solar power plantdevelopment and Engineering, Procurement & Construction
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                    ...
                    <div className="w-full lg:max-w-7xl flex mx-auto flex-col px-6 md:px-20">
                        <div className="w-full flex">
                            <div className="flex w-full flex-col gap-6">
                                ...
                                <p className="text-white pb-[200px]" dangerouslySetInnerHTML={{__html : banner?.description ?? ""}} />
                            </div>
                            <div className="hidden w-0 md:w-80 md:block ">
                                <div className="w-[330px] h-[550px] relative">
                ...
                <div className="w-full bg-[#FABD24] z-40 relative mt-[-120px] flex p-6 items-center justify-center">
                    <Button><DownloadIcon/> Download Company Profile</Button>
                </div>
            </section>
    )
}